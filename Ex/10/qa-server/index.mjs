...
//abilitare cors altrimenti il browser blocca server con diversa origin(policy di sicurezza)
//con corsOption attiviamo solo alcune origin per questo server non tutte(non sicuro)
const corsOptions = {
  origin: 'http://localhost:5173',
  optionsSuccessState: 200 //opzionale--> alcuni browser vogliono 200 e non 204(codice di default) come codice nel protocollo per controllare se cors è accettato
};
